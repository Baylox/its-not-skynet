...
| skills | Baylox | mcp-audit | beta | Revue sécurité statique d'une configuration MCP (`.mcp.json`, bloc `mcpServers` d'un |
| skills | Baylox | new-resource | beta | Skill « contributeur assisté » : à partir de la description d'une ressource, il génère |
| skills | Baylox | pre-pr-check | beta | À lancer juste avant d'ouvrir une PR sur its-not-skynet. Le skill enrobe |
