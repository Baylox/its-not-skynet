...
| ⚙️ | [`configs/`](configs/README.md) | Ready-to-copy config files — `settings.json`, `.mcp.json`, Ollama… |
| 🤖 | [`subagents/`](subagents/README.md) | Specialized subagent definitions |
| 🏗️ | [`architecture/`](architecture/README.md) | Architecture schemas and decisions |
